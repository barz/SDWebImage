            ...
            id <SDWebImageOperation> subOperation = [self.imageDownloader downloadImageWithURL:url options:downloaderOptions progress:progressBlock completed:^(UIImage *downloadedImage, NSData *data, NSError *error, BOOL finished) {
                if (weakOperation.isCancelled) {
                    ...
                    */
                    ...
                    // Hsoi 2014-11-12 - In merging the rs/SDWebImage into the barz/SDWebImage, we had a conflict here.
                    // You can see what I did above, and you can see what they chose to do below.
                    //
                    // Their reasoning is good and likely what we want to do -- I was working around a problem and it
                    // does look like they will handle things. HOPEFULLY. So we'll see. Leaving in my above
                    // change just in case, as reference.
